...
//InsterCustomer(CreateConnection());
...
static void InsterCustomer(SQLiteConnection myConnection)
{
    SQLiteCommand command;
    ...
    int rowInsterted = command.ExecuteNonQuery();
    Console.WriteLine($"Row insterted {rowInsterted}");
